...
router.post('/', rateLimit_middleware_1.createResourceRateLimiter, (0, validation_middleware_1.validate)(project_dto_1.createProjectSchema), (req, res) => projectController.create(req, res));

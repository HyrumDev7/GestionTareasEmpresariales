...
router.post('/', rateLimit_middleware_1.createResourceRateLimiter, (0, validation_middleware_1.validate)(task_dto_1.createTaskSchema), (req, res) => taskController.create(req, res));
